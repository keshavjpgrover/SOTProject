...
CREATE TABLE Ticket (
    ...
    date DATE,
    FOREIGN KEY (booking_id) REFERENCES Booking(booking_id),
    FOREIGN KEY (start_station_id) REFERENCES Station(start_station_id),
    FOREIGN KEY (end_station_id) REFERENCES Station(end_station_id)
);
...
(1005, 'Jawaharlal Nehru Stadium', 'Jangpura', '14:27:00'),
(1005, 'Jangpura', 'Lajpat Nagar', '14:27:00', '14:30:00'),
(1005, 'Lajpat Nagar', 'Moolchand', '14:30:00', '14:33:00'),
(1005, 'Moolchand', 'Kailash Colony', '14:33:00', '14:36:00'),
(1005, 'Kailash Colony', 'Nehru Place', '14:36:00', '14:39:00'),
(1005, 'Nehru Place', 'Kalkaji Mandir', '14:39:00', '14:42:00'),
(1005, 'Kalkaji Mandir', 'Govind Puri', '14:42:00', '14:45:00'),
(1005, 'Govind Puri', 'Okhla', '14:45:00', '14:48:00'),
(1005, 'Okhla', 'Jasola-Apollo', '14:48:00', '14:51:00'),
(1005, 'Jasola-Apollo', 'Sarita Vihar', '14:51:00', '14:54:00'),
(1005, 'Sarita Vihar', 'Mohan Estate', '14:54:00', '14:57:00'),
(1005, 'Mohan Estate', 'Tughlakabad', '14:57:00', '15:00:00'),
(1005, 'Tughlakabad', 'Badarpur Border', '15:00:00', '15:03:00'),
(1005, 'Badarpur Border', 'Sarai', '15:03:00', '15:06:00'),
(1005, 'Sarai', 'NHPC Chowk', '15:06:00', '15:09:00'),
(1005, 'NHPC Chowk', 'Mewala Maharajpur', '15:09:00', '15:12:00'),
(1005, 'Mewala Maharajpur', 'Sector 28', '15:12:00', '15:15:00'),
(1005, 'Sector 28', 'Badkal Mor', '15:15:00', '15:18:00'),
(1005, 'Badkal Mor', 'Old Faridabad', '15:18:00', '15:21:00'),
(1005, 'Old Faridabad', 'Neelam Chowk Ajronda', '15:21:00', '15:24:00'),
(1005, 'Neelam Chowk Ajronda', 'Bata Chowk', '15:24:00', '15:27:00'),
(1005, 'Bata Chowk', 'Escorts Mujesar', '15:27:00', '15:30:00');

-- Ensure the available seats are updated after booking
UPDATE Schedule s
JOIN Booking b ON s.schedule_id = b.schedule_id
SET s.available_seats = s.available_seats - 1
WHERE b.status = 'Booked';

-- Verify the changes in available seats
SELECT * FROM Schedule;
